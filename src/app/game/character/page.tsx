    ...
    <div className="min-h-screen bg-[#0F172A] pt-20 pb-12">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-[#1E293B] rounded-2xl p-6 border border-[#334155]">
          <div className="h-64 bg-[#0F172A] rounded-xl border border-[#475569] flex items-center justify-center">
            <span className="text-[#64748B]">Заглушка: создание персонажа</span>
          </div>
        </div>
      </div>
    </div>
