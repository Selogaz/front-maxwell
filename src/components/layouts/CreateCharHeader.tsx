...
const CreateCharHeader: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#181818] md:bg-[#020106]">
      {/* Desktop layout */}
      <div className="hidden md:block w-full pl-55 pr-8">
        <div className="flex items-center h-16">
          ...
          <nav className="flex items-center gap-4 ml-auto mr-52">
            <button
      ...
      <button className="hidden md:flex absolute right-5 top-1/2 -translate-y-1/2 items-center justify-center hover:opacity-90" type="button">
